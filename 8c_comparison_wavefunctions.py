...
plt.imshow(np.abs(zeta[:,:,int(len(zeta[:,0,0])/2)].real))
plt.xticks(np.linspace(0,120,7),np.round(np.linspace(0,120,7)*h,2))
plt.yticks(np.linspace(0,120,7),np.round(np.linspace(0,120,7)*h,2))
plt.xlabel(r'y ($a_0$)', fontsize=16)
plt.ylabel(r'x ($a_0$)',fontsize=16)
plt.title(r'Contour Plot of $\zeta$(x,y) before SCF',fontsize=16)
plt.savefig('Question8c_contour_before', dpi=300)
plt.show()

plt.plot(np.abs(zeta[:,int(len(zeta[:,0,0])/2),int(len(zeta[:,0,0])/2)].real))
plt.xticks(np.linspace(0,120,7),np.round(np.linspace(0,120,7)*h,2))
plt.xlabel(r'x ($a_0$)',fontsize=16)
plt.ylabel('$\zeta^{(0)}$(x)',fontsize=16)
plt.title('$\zeta$(x) before SCF',fontsize=16)
plt.savefig('Question8c_dens_before', dpi=300)
plt.show()
...
en,z=scf_cycle(zeta, dens, totdens,entot,cycles=100,tol=1e-4,Plot_conv=True)

plt.imshow(np.abs(z[:,:,int(len(zeta[:,0,0])/2)].real))
plt.xticks(np.linspace(0,120,7),np.round(np.linspace(0,120,7)*h,2))
plt.yticks(np.linspace(0,120,7),np.round(np.linspace(0,120,7)*h,2))
plt.xlabel(r'y ($a_0$)',fontsize=16)
plt.ylabel(r'x ($a_0$)',fontsize=16)
plt.title(r'Contour Plot of $\zeta$(x,y) after SCF',fontsize=16)
plt.savefig('Question8c_contour_after', dpi=300)
plt.show()

plt.plot(np.abs(z[:,int(len(zeta[:,0,0])/2),int(len(zeta[:,0,0])/2)].real))
plt.xticks(np.linspace(0,120,7),np.round(np.linspace(0,120,7)*h,2))
plt.xlabel(r'x ($a_0$)',fontsize=16)
plt.ylabel('$\zeta$(x)',fontsize=16)
plt.title('$\zeta$(x) after SCF',fontsize=16)
plt.savefig('Question8c_dens_after', dpi=300)
plt.show()